...
const routes = [
  {
    ...
    children: [
      ...
      { name: 'testHomePage', path: '/testHomePage', component: () => import('pages/PsychologyTests/Home.vue') },
      { name: 'analysis', path: '/analysis', component: () => import('pages/PsychologyTests/Analysis') },
      { name: 'Reports', path: '/report', component: () => import('pages/report.vue') },
      ...
      { name: 'Products', path: '/Products', component: () => import('pages/IranianMerchant/Products.vue') },
